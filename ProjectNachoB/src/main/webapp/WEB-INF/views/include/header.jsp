...
@font-face {
  ...
  src: url('/resources/css/font/EliceDigitalBaeum_Regular.ttf');
	...
	#searcherForHwan{					/* 검색창 들이 달라져서 추가(장환석) */
		position : relative;
		top : -5px;
		left : -275px;	 
	}
	...
	<nav>
		<form>
			<div class="testHead">
				...
				<div class="TestSerch">
					<input class="testFontEDR" id="searcherForHwan" type="text" name="value" placeholder="영화, 작품명, 감독, 배우를 검색해보세요." style="width: 300px; height: 20px;">
